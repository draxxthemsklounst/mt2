...
public class Node {
	...
	* This is the constructor for the Node class.
 	*
 	* @param key is the int ID for this node. 
 	*/
	Node (int key) {
		ID = key;
	...
	*
	* @param neighbor is a Node object to add to the neighbor list.
	*/
	...
	*
	* @return an int specifying the ID of this node. Adds one to ID since input file is 1-based, but internal rep is 0-based.
	*/
	public String toString() {
		return Integer.toString(this.ID + 1);
	}
}
